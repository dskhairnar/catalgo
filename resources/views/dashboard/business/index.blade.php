...
<li><a href="{{ route('business.listings') }}"><i class="fas fa-list me-2"></i>My Listings</a></li>
...
<li><a href="{{ route('business.analytics') }}"><i class="fas fa-chart-line me-2"></i>Analytics</a></li>
@endsection
...
<div class="card mb-4">
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h2 class="h3 mb-1">{{ auth()->user()->business->name ?? 'Your Business Name' }}</h2>
                <p class="text-muted mb-2">{{ auth()->user()->business->category ?? 'Health & Wellness' }}</p>
            ...
            <div class="col-md-3 text-md-end mt-3 mt-md-0">
                <a href="{{ route('business.profile.edit') }}" class="btn btn-outline-primary">
    ...
    <div class="col-md-3 mb-3">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <h4 class="display-6 mb-0">{{ $activeListings ?? 5 }}</h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <h4 class="display-6 mb-0">{{ $totalBookings ?? 12 }}</h4>
                <p class="text-muted small mb-0">
                    <i class="fas fa-arrow-up text-success me-1"></i>
...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="h5 mb-0">Your Listings</h3>
        <a href="{{ route('business.listings') }}" class="btn btn-sm btn-outline-primary">View All</a>
    </div>
